classdef (Abstract) Polar_SpectralFourierNoOrigin < SpectralFourier
    ...
    methods (Access = public)            
        ...
        function Ind = ComputeIndices(this)
            ...
            normalOutRCart = this.GetCartVec(normalOutR);
            normalInR  = sparse( [nRin(inR,:)  Z(inR,:)]);
            normalInRCart = this.GetCartVec(normalInR);
            ...
            Ind = struct('outR',outR,...
                       'normalOutR',normalOutR, 'normalOutRCart', normalOutRCart,...
                       'inR',inR,...
                       'normalInR', normalInR, 'normalInRCart', normalInRCart,...
                       'bound', (outR | inR),...
                       'normal', [normalOutR;normalInR], ...
                       'normalCart', [normalOutRCart;normalInRCart], ...
