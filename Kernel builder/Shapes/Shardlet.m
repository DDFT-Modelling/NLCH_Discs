 classdef Shardlet < M1SpectralSpectral
    properties 
    ...
    methods
        function this = Shardlet(Geometry)
            %% Basic setup
        ...
        function [y1_kv,y2_kv,J] = PhysSpace(this,x1,x2)
            ...
            % Find top or bottom coordinates of horizontal side
            x_H_right = -this.d;            y_H_right = this.s * this.R_2;
            x_H_left  = -sqrt( clip(this.R_1^2 - this.R_2^2, 0, Inf) );
            y_H_left  = this.s * this.R_2;
            ...
            right = -this.d - sqrt( clip(this.R_2^2 - y2_kv.^2, 0, this.R_2^2) );
